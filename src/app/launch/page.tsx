...
import { Download, Shield, Heart, Zap } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white font-sans">
            <header className="container mx-auto px-6 py-8 flex justify-between items-center">
                ...
                <nav className="space-x-4">
                    ...
                    <a href="/login" className="px-4 py-2 bg-white/10 rounded-full hover:bg-white/20 transition">Login</a>
                </nav>
            </header>
            ...
            <main className="container mx-auto px-6 py-12 text-center md:text-left">
                <div className="md:flex items-center justify-between">
                    <div className="md:w-1/2 space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 pt-4">
                            ...
                            <button className="flex items-center justify-center gap-2 px-8 py-4 bg-indigo-600/50 text-white rounded-full font-bold hover:bg-indigo-600/70 transition border border-indigo-500/30">
                                Use Web App
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center relative">
                        ...
                        <div className="relative z-10 w-64 h-[500px] bg-black border-4 border-gray-800 rounded-[3rem] shadow-2xl overflow-hidden flex items-center justify-center">
                            ...
                            {/* <Image src="/screenshots/1.png" width={300} height={600} alt="Alora App" /> */}
                        </div>
                    </div>
                </div>
                ...
                <section id="features" className="mt-24 grid md:grid-cols-3 gap-8">
                    ...
                    <div className="p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                        ...
                        <p className="text-gray-400">Verified profiles, anti-harassment AI, and strict privacy.</p>
                    </div>
                    <div className="p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                        <Zap className="w-10 h-10 text-yellow-400 mb-4" />
                        <h3 className="text-xl font-bold mb-2">Real Connections</h3>
                        <p className="text-gray-400">Voice intros, icebreakers, and events to spark conversation.</p>
                    </div>
                </section>
            </main>

            <footer className="container mx-auto px-6 py-8 mt-12 border-t border-white/10 text-center text-gray-500 text-sm">
                <p>&copy; 2025 Alora Inc. All rights reserved.</p>
