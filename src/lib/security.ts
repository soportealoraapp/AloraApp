 ...
 * Uses unsafe-inline for styles because Next.js injects inline styles.
 * unsafe-eval is REMOVED for security — it was a XSS vector.
 * TODO: Migrate to nonce-based CSP when Next.js + Supabase SSR supports it.
 */
