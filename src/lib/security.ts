...
export function getCSP(): string {
    const directives = [
        ...
        `img-src 'self' blob: data: https://*.uploadthing.com https://utfs.io https://*.ufs.sh https://*.supabase.co https://lh3.googleusercontent.com https://placehold.co https://picsum.photos https://i.scdn.co https://firebasestorage.googleapis.com`,
        ...
        `media-src 'self' blob: https://utfs.io https://*.utfs.io https://*.ufs.sh`,
