        ...
        <div className="space-y-3">
            ...
            {likers.length === 0 ? (
                ...
                <div className="grid grid-cols-2 gap-3">
                    {likers.map((liker) => (
                        <Card key={liker.uid} className="overflow-hidden hover:shadow-md transition-shadow">
                            <div className="aspect-[4/5] relative">
                                ...
                                <div className="absolute bottom-2 left-2 text-white">
                                    <p className="font-bold text-sm">{liker.displayName}, {liker.age}</p>
                                    <p className="text-[10px] opacity-80">{liker.city}</p>
                                </div>
                            </div>
                        </Card>
                    ))}
